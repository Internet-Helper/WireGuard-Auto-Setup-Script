...
create_config() {
    ...
    while true; do
        ...
        echo "   Для выхода в интернет через один роутер и для доступа в локальные сети всех роутеров."
        echo "   Обязательно требуется настроить NAT для WireGuard на роутерах по инструкции:"
        echo "   🔗 https://github.com/Internet-Helper/WireGuard-Auto-Setup-Script/wiki"
        echo
